...
#[openapi(
      paths(
        ...
        crate::routes::user::get_users_by_ids,
        // Admin Paths
    ...
    components(
        schemas(
            common::auth::RegisterInput,
            common::auth::LoginInput,
            common::auth::UpdateProfileInput,
            common::auth::AddRecoveryInfoInputs,
            common::auth::VerifyRecoveryInfoInputs,
            common::auth::VerifyRecoveryInfoOutputs,
            crate::routes::user::UserSearchResult,
            common::auth::ByIdsInput,
...
pub fn create_routes(pool: PgPool) -> Router {
    ...
    let routes_with_middleware = Router::new()
        ...
        .route("/users/by-ids", post(user::get_users_by_ids))
        //Admin Routes
